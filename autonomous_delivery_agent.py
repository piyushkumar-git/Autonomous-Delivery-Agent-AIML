...
If you submit this to git, include a small requirements.md listing:
  - Python 3.8+
  - matplotlib (optional, for plotting demo)

Notes for submission:
 - The automatic evaluator may run planners via the CLI. The CLI supports
   --planner [bfs|ucs|astar|local] and prints JSON metrics to stdout.
 - For dynamic replanning: run with --dynamic-log to produce a logfile showing
   obstacle appearance and replanning steps (proof-of-concept requirement).
